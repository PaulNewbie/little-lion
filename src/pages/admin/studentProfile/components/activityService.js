...
class ActivityService {
      ...
      const addResult = (doc, sourceCollection) => {
        if (!seenIds.has(doc.id)) {
          ...
          results.push({ 
            ...
            // IMPORTANT: This tells the messaging system which collection to use
  ...
  // =========================================================
  // 5. NEW MESSAGING METHODS (Must be inside the Class)
  // =========================================================
  ...
  async getComments(activityId, collectionName) {
    try {
      ...
      // Sort by creation time so messages appear in order
